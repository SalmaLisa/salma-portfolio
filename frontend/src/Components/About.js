  ...
  return (
    ...
    <h1 className="text-4xl font-bold mt-5 text-lime-500">About Me</h1>
       <h1 className="text-2xl font-semibold my-4 ">Why You Hire Me?</h1>
            <p className="py-6">Over the couple of months, I created 15+ of websites. I am very sincere and responsible about my work and deadline. I am committed to serve you quality work and constant service until your satisfaction.</p>
          </div>
